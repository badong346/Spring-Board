...
<script>
            window.onload = function(){
                document.getElementById("check").onsubmit = function(){
                    ...
                    var regexid = /[A-Za-z]{4,12}/;
                    var checkid = regexid.test(id);
                    if(!checkid){
                        alert("아이디는 4~12글자의 알파벳 대소문자로 만들어야 합니다.")
                    }
...
<body>
	<div class="wrapper">
		<form id=check action=signup method="post">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col">
					<div>
						<input type="text" placeholder="4~12글자의 알파벳 대소문자" id="id"
							name="id"> <input type="button" value="중복확인">
					</div>
				</div>
			</div>
