...
<body>
	<div class="container">
		<div class=contents>
			<h3>게시판</h3>
			<form id="contentsform" action="boardWrite" method="post" enctype="multipart/form-data">
				<div class="row top">
					...
					<div class="col-8 col-sm-9 search-box">
						<input type="text" id="title" name="title"
							...
							aria-describedby="button-addon2" maxlength="100" value=${bdtoList[0].title}>
					</div>
					<div class="col-12">
						<textarea id="contents" name="contents" placeholder="내용을 작성해주세요."
							rows="14" maxlength="4000" value="${bdtoList[0].contents}"></textarea>
					</div>
<div class="col-12">
