...
//	}
	...
	public int fileWrite(BoardDTO bdto, FileDTO fdto) throws Exception {
		return fdao.insert(bdto, fdto);
	}
	
	
	public FileDTO getFileBySeq(int seq) throws Exception{
		FileDTO fdto = fdao.selectBySeq(seq);
		return fdto;
	}
	
	public List<BoardDTO> select(BoardDTO dto) throws Exception{
		List<BoardDTO> bdtoList = bdao.select(dto);
		return bdtoList;
	}
	public List<FileDTO> selectFileByPSeq(int pseq) throws Exception{
		List<FileDTO> fdto = fdao.selectByPSeq(pseq);
		return fdto;
	}
