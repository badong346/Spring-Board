...
//		int result = mdao.signup(new MemberDTO(id,pw,name,phone,email,zipcode,address1,address2));
		int result = mservice.signup(new MemberDTO(id,pw,name,phone,email,zipcode,address1,address2));
	...
	public String login(String id, String pw, ServletRequest request) throws Exception{
		...
		if(mdto != null) {
			this.session.setAttribute("loginInfo", mdto);
...
//		boolean result= true;
//		result = mservice.duplCheck(id);

		return mservice.duplCheck(id);
	}
	...
	public String withdrawal() throws Exception{
		MemberDTO beforedto = (MemberDTO)session.getAttribute("loginInfo");
...
//		mdao.deleteById(id);
	...
	public String modify(HttpServletRequest request) throws Exception{
		MemberDTO beforedto = (MemberDTO)session.getAttribute("loginInfo");
		String id = beforedto.getId();
		String pw = beforedto.getPw();
		System.out.println("기존 pw 유지 : "+pw);
		if(request.getParameter("pw") != null) {
			pw = request.getParameter("pw");
			System.out.println("수정된 pw : "+pw);
		}
		...
		String address1 = request.getParameter("address1");
		String address2 = request.getParameter("address1");
		MemberDTO mdto = new MemberDTO(id,pw,name,phone,email,zipcode,address1,address2);

//		int result = mdao.updateByDTO(mdto);
		int result = mservice.updateByDTO(mdto);
